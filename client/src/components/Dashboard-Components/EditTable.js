...
function EditTable() {
    ...
    const downloadQRCode = () => {
        saveAs(table.QR_Url, `${table.Table_No}.png`)
    }
                  ...
                  <div id="contact-form" role="form">
                    <div className="controls">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          {/* <button type="submit" className="btn btn-primary mt-3 btn-block" style={{color: 'white'}} onClick={() => getQrCode()}>Generate QR Code</button> */}
                        ...
                        <div className="col-md-12 mt-5">
                          <button type="submit" className="btn btn-primary pt-2 btn-block" style={{color: 'white'}} onClick={() => editTableDetail()}>Edit Table</button>
                        </div>
                    </div>
                  </div>
                </div>
